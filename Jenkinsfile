  ...
  stages {
   ...
   /*
    ...
    stage ('Software Composition Analysis') {
      ...
      dependencyTrackPublisher artifact: 'bom.xml', artifactType: 'bom', autoCreateProjects: false, dependencyTrackApiKey: '', dependencyTrackFrontendUrl: '', dependencyTrackUrl: 'http://104.197.232.205:8080', projectId: 'a4024f95-2dbc-4c7a-9206-2249c1b22e29', synchronous: true
