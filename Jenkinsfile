   ...
   /*
    ...
    stage ('Software Composition Analysis') {
      ...
      //mail bcc: '', body: 'Please check your report ODC here http://34.72.61.98:8080/job/webapp-cicd-dvja/65/execution/node/3/ws/dependency-check-report.xml', cc: '', from: '', replyTo: '', subject: 'Your Findings Report', to: 'shazil.imri@gmail.com'
        dependencyTrackPublisher artifact: 'bom.xml', autoCreateProjects: true, dependencyTrackApiKey: 'a9f819f5-83d4-45db-98ad-825d35f78935', dependencyTrackFrontendUrl: '', dependencyTrackUrl: 'http://104.197.232.205:8080', overrideGlobals: true, projectId: 'a4024f95-2dbc-4c7a-9206-2249c1b22e29', synchronous: true  
