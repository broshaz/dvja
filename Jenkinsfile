  ...
  stages {
   ...
   /*
    ...
    stage ('Software Composition Analysis') {
      ...
      dependencyTrackPublisher artifact: 'dependency-check-report.xml', autoCreateProjects: false, dependencyTrackApiKey: 'API_KEY', dependencyTrackFrontendUrl: 'http://104.197.232.205:8080', dependencyTrackUrl: 'http://104.197.232.205:8080', projectId: 'a4024f95-2dbc-4c7a-9206-2249c1b22e29', synchronous: true
